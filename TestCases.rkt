...
(test-equal? "test47"
  ...
  (check-equal? (eval-exp (cnd (isls (num 4) (num 5)) (num 1) (bool #t))) (num 1) "test53")
  (check-equal? (eval-exp (cnd (iseq (num 4) (num 4)) (bool #f) (munit))) (bool #f) "test54")
  (check-equal? (eval-exp (cnd (isls (num 4) (num -4)) (num 1) (num 0))) (num 0) "test55")
  
(check-exn exn:fail?
              (lambda () (eval-exp (cnd (isgt (bool #t) (num -4)) (num 1) (num 0))))
              "test56")
(check-exn exn:fail?
              (lambda () (eval-exp (cnd (isls (apair (munit) (munit)) (num -4)) (num 1) (num 0))))
              "test57")
...
(test-equal? "test62"
               (bool #f)
               (eval-exp (cnd (isls (plus (num 3) (num 2)) (mult (num 2) (num 5)))
  ...
  (test-equal? "test66"
   ...
   (check-equal? (eval-exp (apply (lam "a" "b" (cnd (isls (var "b") (num 5)) (plus (var "b") (num 3))
...
(check-equal? (eval-exp (apply (lam "fact" "n" 
 ...
 (check-equal? (eval-exp (mult (mult (num 3) (num 2)) (mult (num 3) (num 4)))) (num 72) "test86")
   ...
   (check-equal? (eval-exp (with "x" (num 1) (lam null "a" (var "x"))))
      ...
      (check-exn exn:fail? (lambda () (eval-exp (cnd (isls "1" (num 2)) (num 3) (num 4)))) "test96")
   ...
   (check-equal? (eval-exp (with "double" (lam "double" "x" (plus (var "x") (var "x")))
    ...
    (eval-exp
     (with "range"
           (lam "range" "lo"
                (lam null "hi"
                     (cnd   (orelse  (iseq  (var "hi") (var "lo")) (isls  (var "hi") (var "lo")) ) (munit)
    ...
    (apair (num 5) (apair (num 6) (apair (num 7)  (munit)))) "test111")
      ...
      (check-equal?
 (eval-exp (apply (lam "a" "b" (cnd (isls (num 5) (var "b")) (plus (var "b") (num 3))
...
(check-equal? (eval-exp
                 (apply (apply (apply numex-fold (lam null "x" (lam null "y" (plus (var "x") (var "y"))))) (num 0)) (racketlist->numexlist (list (num 1) (num 2) (num 3) (num 4) (num 5)))))
                 (num 15) "test121")

(check-equal? (eval-exp
                 (apply (apply (apply numex-fold (lam null "x" (lam null "y" (mult (var "x") (var "y"))))) (num 0)) (racketlist->numexlist (list (num 1) (num 2) (num 3) (num 4) (num 5)))))
                 (num 0) "test122")
(check-equal? (eval-exp
                 (apply (apply (apply numex-fold (lam null "x" (lam null "y" (mult (var "x") (var "y"))))) (num 1)) (racketlist->numexlist (list (num 1) (num 2) (num 3) (num 4) (num 5)))))
                 (num 120) "test123")

(check-equal? (eval-exp
                 (apply (apply (apply numex-fold (lam null "x" (lam null "y" (mult (var "x") (var "y"))))) (num 10)) (racketlist->numexlist (list))))
                 (num 10) "test124")

(check-equal? (eval-exp
                 (apply (apply (apply numex-fold (lam null "x" (lam null "y" (apair (plus (num 1)(var "x")) (var "y"))))) (munit)) (racketlist->numexlist (list (num 1) (num 2) (num 3) (num 4) (num 5)))))
                 (racketlist->numexlist (list (num 2) (num 3) (num 4) (num 5) (num 6))) "test125")

(check-equal? (eval-exp
                 (apply (apply numex-concat (racketlist->numexlist (list (num 2) (num 3)))) (racketlist->numexlist (list (num 4) (num 5) (num 6)))))
                 (racketlist->numexlist (list (num 2) (num 3) (num 4) (num 5) (num 6))) "test126")

(check-equal? (eval-exp
                 (apply (apply numex-concat (racketlist->numexlist (list (num 4) (num 5) (num 6)))) (racketlist->numexlist (list))))
                 (racketlist->numexlist (list (num 4) (num 5) (num 6))) "test127")

(check-equal? (eval-exp
                 (apply (apply numex-concat (racketlist->numexlist (list))) (racketlist->numexlist (list (num 4) (num 5) (num 6)))))
                 (racketlist->numexlist (list (num 4) (num 5) (num 6))) "test128")

(check-equal? (eval-exp
                 (apply (apply numex-concat (racketlist->numexlist (list))) (racketlist->numexlist (list))))
                 (racketlist->numexlist (list)) "test129")


(check-equal? (eval-exp
                (apply (apply numex-bind (lam null "x"  (apair (var "x") (apair (mult (num 10) (var "x")) (munit))))) (racketlist->numexlist (list (num 1) (num 2) (num 3)))))
                (racketlist->numexlist (list (num 1) (num 10) (num 2)(num 20) (num 3)(num 30))) "test130")

(check-equal? (eval-exp
                (apply (apply numex-bind (lam null "x"  (apair (plus (num 1) (var "x")) (apair (var "x") (apair (mult (num 10) (var "x")) (munit)))))) (racketlist->numexlist (list (num 1) (num 2) (num 3)))))
                (racketlist->numexlist (list (num 2) (num 1) (num 10) (num 3) (num 2)(num 20) (num 4)(num 3)(num 30))) "test131")

(check-equal? (eval-exp
                (apply (apply numex-bind (lam null "x"  (apair (plus (num 1) (var "x")) (apair (var "x") (apair (mult (num 10) (var "x")) (munit)))))) (racketlist->numexlist (list ))))
                (racketlist->numexlist (list)) "test131*")
...
(check-equal? (eval-exp (isls (num 2) (num -2))) (bool #f) "test209") 
(check-equal? (eval-exp (orelse (isls (num 2) (num 2)) (bool #f))) (bool #f) "test210")
(check-equal? (eval-exp (isls (num -10) (num -2))) (bool #t) "test211")    
(check-equal? (eval-exp (orelse (isgt (num 2) (num 2)) (bool #f))) (bool #f) "test212")
(check-equal? (eval-exp (isgt (num 2) (num -2))) (bool #t) "test213") 
(check-equal? (eval-exp (isgt (num -10) (num -2))) (bool #f) "test214") 
(check-equal? (infer-exp (isls (num 1) (num 2))) "bool" "test215")
(check-equal? (infer-exp (isgt (num 1) (num 2))) "bool" "test216")
(check-equal? (infer-exp (isls (plus (num 1) (num 2)) (neg (num 2)))) "bool" "test217")
(check-exn exn:fail? (lambda () (infer-exp (isls (plus (num 1) (num 2)) (neg (bool #f))))) "test218")
(check-exn exn:fail? (lambda () (infer-exp (isls (bool #t) (num 2)))) "test219")
(check-exn exn:fail? (lambda () (infer-exp (isgt (bool #f) (bool #t) ))) "test220")

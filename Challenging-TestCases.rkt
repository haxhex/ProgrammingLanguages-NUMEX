...
(check-equal? 	(fun-challenge-freevars (compute-free-vars (lam null "x" (cnd (neg (iseq (div (var "x") (var "y")) (num 0))) (neg (var "p")) (minus (var "s")(var "t"))))))
				(set "y" "p" "s" "t") 
				"compute-free-vars test #8")
				
(check-equal? 	(fun-challenge-freevars (compute-free-vars (lam null "x" (cnd (isls (neg (mult (var "x") (var "y"))) (neg (var "p"))) (neg (andalso (var "bt")(var "bt"))) (orelse (var "bf")(var "bf"))))))
				(set "y" "p" "bt" "bf") 
...
(check-equal? 	(fun-challenge-freevars (compute-free-vars (lam "y" "x" (lam "z" "p" (cnd (isls (neg (mult (var "x") (var "y"))) (neg (var "p"))) (plus (var "s")(var "x")) (plus (var "s")(var "z")))))))
				(set "s") 
...
(check-equal? 	(closure-env (eval-exp-c (with* envList (lam null "x" (cnd (neg (iseq (mult (var "x") (var "y")) (num 0))) (neg (var "p")) (plus (var "s")(var "t")))))))
				(list (cons "s" (num 11)) (cons "t" (num 7))(cons "p" (num 5))(cons "y" (num 3))) ;OR any permutation
				"eval-exp-c test #12")
				
(check-equal? 	(closure-env (eval-exp-c (with* envList (lam null "x" (cnd (isls (neg (mult (var "x") (var "y"))) (neg (var "p"))) (plus (var "s")(var "x")) (plus (var "s")(var "z")))))))
				
				(list (cons "s" (num 11))(cons "p" (num 5)) (cons "z" (num 4))(cons "y" (num 3))) ;OR any permutation
				"eval-exp-c test #9")
				
(check-equal? 	(closure-env (eval-exp-c (with* envList (lam "y" "x" (apply (lam "z" "p" (cnd (isls (neg (mult (var "x") (var "y"))) (neg (var "p"))) (plus (var "s")(var "x")) (plus (var "s")(var "z")))) (var "p"))))))
				
				(list (cons "s" (num 11))(cons "p" (num 5))) ;OR any permutation
				"eval-exp-c test #10")

(check-equal? 	(closure-env (eval-exp-c (with* envList (lam "y" "x" (lam "z" "p" (cnd (isls (neg (mult (var "x") (var "y"))) (neg (var "p"))) (plus (var "s")(var "x")) (plus (var "s")(var "z"))))))))
...
(check-equal? 	(closure-env (eval-exp-c (with* envList (lam null "x" 	
(apply (lam "a" "b" (cnd (isls (var "b") (var "u")) (plus (var "b") (num 3))
